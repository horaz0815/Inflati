@echo off
REM Script zum Erstellen von Platzhalter-Assets für die Speiseplan-App (Windows)
REM Verwendet placeholder.com für schnelle Testbilder

echo 🎨 Erstelle Platzhalter-Assets für die Speiseplan-App...
echo.

REM Assets-Ordner erstellen
if not exist assets mkdir assets

REM Farben für militärisches Design
set BG_COLOR=2C3E2F
set FG_COLOR=8B7355
